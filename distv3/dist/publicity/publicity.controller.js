...
let PublicityController = class PublicityController {
    ...
    create(file, createPublicityDto) {
        if (!file) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_publicity_dto_1.CreatePublicityDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], PublicityController.prototype, "findAllActivePublicity", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('img', {
        storage: (0, multer_1.diskStorage)({
            destination: (0, path_1.join)(process.cwd(), 'uploads/publicity'),
            filename: (req, file, callback) => {
                const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1e9);
