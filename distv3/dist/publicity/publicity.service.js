...
let PublicityService = class PublicityService {
    ...
    async update(id, updatePublicityDto) {
        ...
        if (updatePublicityDto.img) {
            dataToUpdate.img = updatePublicityDto.img.split('uploads/')[1];
        }
    ...
    async remove(id) {
        try {
            ...
            console.log(error);
            throw new common_1.InternalServerErrorException('Erreur lors de la suppression de la publicité');
        }
    }
};
